...
public class PlatformChannel {
            ...
            public void onMethodCall(MethodCall call, MethodChannel.Result result) {
                ...
                try {
                    switch (method.hashCode()) {
                        case -1501580720:
                            if (method.equals("SystemNavigator.setFrameworkHandlesBack")) {
                                c = '\t';
                                break;
                            }
                            break;
                        case -931781241:
                            if (method.equals("Share.invoke")) {
                                c = 14;
                                break;
                            }
                            break;
                    ...
                    switch (c) {
                        ...
                        case 2:
                            try {
                                ...
                                result.error(Constants.IPC_BUNDLE_KEY_SEND_ERROR, exception3.getMessage(), null);
                                return;
                            }
                        case 3:
                            try {
                                ...
                                result.error(Constants.IPC_BUNDLE_KEY_SEND_ERROR, exception4.getMessage(), null);
                                return;
                            }
                        case 4:
                            try {
                                ...
                                result.error(Constants.IPC_BUNDLE_KEY_SEND_ERROR, exception5.getMessage(), null);
                                return;
                            }
                        case 5:
                            try {
                                ...
                                result.error(Constants.IPC_BUNDLE_KEY_SEND_ERROR, exception6.getMessage(), null);
                                return;
                            }
                        case 6:
                        ...
                        case '\b':
                            try {
                                ...
                                result.error(Constants.IPC_BUNDLE_KEY_SEND_ERROR, exception7.getMessage(), null);
                                return;
                            }
                        case '\t':
                            boolean frameworkHandlesBack = ((Boolean) arguments).booleanValue();
                            PlatformChannel.this.platformMessageHandler.setFrameworkHandlesBack(frameworkHandlesBack);
                            result.success(null);
                            return;
                        case '\n':
                        ...
                        case 11:
                            ...
                            if (contentFormatName != null) {
                                try {
                                    ...
                                    result.error(Constants.IPC_BUNDLE_KEY_SEND_ERROR, "No such clipboard content format: " + contentFormatName, null);
                                }
                            }
                        ...
                        case 14:
                            ...
                            PlatformChannel.this.platformMessageHandler.share(text);
                            result.success(null);
                            return;
                        default:
                    ...
                    result.error(Constants.IPC_BUNDLE_KEY_SEND_ERROR, "JSON error: " + e2.getMessage(), null);
                }
                result.error(Constants.IPC_BUNDLE_KEY_SEND_ERROR, "JSON error: " + e2.getMessage(), null);
            }
        };
    ...
    public AppSwitcherDescription decodeAppSwitcherDescription(JSONObject encodedDescription) throws JSONException {
        ...
        String label = encodedDescription.getString(Constants.ScionAnalytics.PARAM_LABEL);
    ...
    public interface PlatformMessageHandler {
        ...
        public final /* synthetic */ class CC {
            public static void $default$setFrameworkHandlesBack(PlatformMessageHandler _this, boolean frameworkHandlesBack) {
            }
        }
    }
