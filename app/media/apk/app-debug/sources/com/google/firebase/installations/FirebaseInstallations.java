...
public class FirebaseInstallations implements FirebaseInstallationsApi {
    ...
    public FirebaseInstallations(final FirebaseApp firebaseApp, Provider<HeartBeatController> heartBeatProvider, ExecutorService backgroundExecutor, Executor networkExecutor) {
    ...
    public Task<String> getId() {
        ...
        this.backgroundExecutor.execute(new Runnable() { // from class: com.google.firebase.installations.FirebaseInstallations$$ExternalSyntheticLambda3
            ...
            public final void run() {
                FirebaseInstallations.this.m98xc18eb11d();
            }
        });
        return task;
    }
    ...
    public /* synthetic */ void m98xc18eb11d() {
        m99x7147f7aa(false);
    }
    ...
    public Task<InstallationTokenResult> getToken(final boolean forceRefresh) {
        ...
        this.backgroundExecutor.execute(new Runnable() { // from class: com.google.firebase.installations.FirebaseInstallations$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                FirebaseInstallations.this.m99x7147f7aa(forceRefresh);
            }
        });
        return task;
    }
    ...
    public final void m99x7147f7aa(final boolean forceRefresh) {
        ...
        this.networkExecutor.execute(new Runnable() { // from class: com.google.firebase.installations.FirebaseInstallations$$ExternalSyntheticLambda0
            @Override // java.lang.Runnable
            public final void run() {
                FirebaseInstallations.this.m97x5a306a82(forceRefresh);
            }
        });
    }
    ...
    */
    public void m97x5a306a82(boolean r5) {
        /*
            r4 = this;
        ...
        L61:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.firebase.installations.FirebaseInstallations.m97x5a306a82(boolean):void");
    }
