...
public class FlutterJNI {
    ...
    public void SetIsRenderingToImageView(boolean value) {
        nativeSetIsRenderingToImageView(this.nativeShellHolderId.longValue(), value);
    }
    ...
    public void registerImageTexture(long textureId, TextureRegistry.ImageConsumer imageTexture) {
        ensureRunningOnMainThread();
        ensureAttachedToNative();
        nativeRegisterImageTexture(this.nativeShellHolderId.longValue(), textureId, new WeakReference<>(imageTexture));
    }
    ...
    public float getScaledFontSize(float fontSize, int configurationId) {
        ...
        return TypedValue.applyDimension(2, fontSize, metrics) / metrics.density;
    }
