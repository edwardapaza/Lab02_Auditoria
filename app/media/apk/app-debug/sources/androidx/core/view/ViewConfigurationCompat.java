...
public final class ViewConfigurationCompat {
    ...
    public static int getScaledMinimumFlingVelocity(Context context, final ViewConfiguration config, int inputDeviceId, int axis, int source) {
        ...
        if (isInputDeviceInfoValid(inputDeviceId, axis, source)) {
            ...
            return getCompatFlingVelocityThreshold(res, preApi34MinimumFlingVelocityResId, new Supplier() { // from class: androidx.core.view.ViewConfigurationCompat$$ExternalSyntheticLambda0
    ...
    public static int getScaledMaximumFlingVelocity(Context context, final ViewConfiguration config, int inputDeviceId, int axis, int source) {
        ...
        if (isInputDeviceInfoValid(inputDeviceId, axis, source)) {
            ...
            Objects.requireNonNull(config);
            return getCompatFlingVelocityThreshold(res, preApi34MaximumFlingVelocityResId, new Supplier() { // from class: androidx.core.view.ViewConfigurationCompat$$ExternalSyntheticLambda1
                @Override // androidx.core.util.Supplier
                public final Object get() {
