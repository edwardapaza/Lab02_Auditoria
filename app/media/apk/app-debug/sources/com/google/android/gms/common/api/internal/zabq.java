...
public final class zabq implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, zau {
    ...
    private final boolean zaM(zai zaiVar) {
        ...
        if (indexOf >= 0) {
            ...
            handler6.sendMessageDelayed(Message.obtain(handler7, 15, zabsVar2), DeviceOrientationRequest.OUTPUT_PERIOD_FAST);
            return false;
        }
        ...
        handler2 = googleApiManager2.zar;
        handler.sendMessageDelayed(Message.obtain(handler2, 15, zabsVar), DeviceOrientationRequest.OUTPUT_PERIOD_FAST);
