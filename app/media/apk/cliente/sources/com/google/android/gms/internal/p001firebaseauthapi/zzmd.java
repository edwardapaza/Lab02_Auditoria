...
public final class zzmd {
    ...
    private static zzmg zza(zzmg zzmgVar, zzmg zzmgVar2, BigInteger bigInteger, BigInteger bigInteger2) {
        if (zzmgVar.zza()) {
            return zzmgVar2;
        }
        if (zzmgVar2.zza()) {
        ...
        BigInteger bigInteger3 = zzmgVar.zzd;
        BigInteger mod = bigInteger3.multiply(bigInteger3).mod(bigInteger2);
        BigInteger bigInteger4 = zzmgVar2.zzd;
        BigInteger mod2 = bigInteger4.multiply(bigInteger4).mod(bigInteger2);
        BigInteger mod3 = zzmgVar.zzb.multiply(mod2).mod(bigInteger2);
        BigInteger mod4 = zzmgVar2.zzb.multiply(mod).mod(bigInteger2);
        BigInteger mod5 = zzmgVar.zzc.multiply(zzmgVar2.zzd).mod(bigInteger2).multiply(mod2).mod(bigInteger2);
        BigInteger mod6 = zzmgVar2.zzc.multiply(zzmgVar.zzd).mod(bigInteger2).multiply(mod).mod(bigInteger2);
        if (mod3.equals(mod4)) {
            return !mod5.equals(mod6) ? zzmg.zza : zza(zzmgVar, bigInteger, bigInteger2);
        }
        ...
        BigInteger add = zzmgVar.zzd.add(zzmgVar2.zzd);
        return new zzmg(mod12, mod13, add.multiply(add).mod(bigInteger2).subtract(mod).subtract(mod2).multiply(mod7).mod(bigInteger2));
    }

    private static zzmg zza(zzmg zzmgVar, BigInteger bigInteger, BigInteger bigInteger2) {
        if (zzmgVar.zzc.equals(BigInteger.ZERO)) {
            return zzmg.zza;
        }
        BigInteger bigInteger3 = zzmgVar.zzb;
        BigInteger mod = bigInteger3.multiply(bigInteger3).mod(bigInteger2);
        BigInteger bigInteger4 = zzmgVar.zzc;
        BigInteger mod2 = bigInteger4.multiply(bigInteger4).mod(bigInteger2);
        BigInteger mod3 = mod2.multiply(mod2).mod(bigInteger2);
        BigInteger bigInteger5 = zzmgVar.zzd;
        BigInteger mod4 = bigInteger5.multiply(bigInteger5).mod(bigInteger2);
        BigInteger add = zzmgVar.zzb.add(mod2);
        ...
        BigInteger add3 = zzmgVar.zzc.add(zzmgVar.zzd);
                ...
                if (bigInteger.compareTo(eCParameterSpec.getOrder()) < 0) {
                    ...
                    for (int bitLength = bigInteger.bitLength(); bitLength >= 0; bitLength--) {
                        if (bigInteger.testBit(bitLength)) {
                            zza3 = zza(zza3, zza4, a5, zza2);
                            zza4 = zza(zza4, a5, zza2);
                        } else {
                            zza4 = zza(zza3, zza4, a5, zza2);
                            zza3 = zza(zza3, a5, zza2);
                        }
                    }
                    if (zza3.zza()) {
