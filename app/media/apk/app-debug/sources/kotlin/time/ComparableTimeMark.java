...
public interface ComparableTimeMark extends TimeMark, Comparable<ComparableTimeMark> {
    ...
    ComparableTimeMark mo1485minusLRDsOJo(long j);

    /* renamed from: minus-UwyO8pc */
    long mo1486minusUwyO8pc(ComparableTimeMark comparableTimeMark);

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    ComparableTimeMark mo1487plusLRDsOJo(long j);
    ...
    public static final class DefaultImpls {
        ...
        public static ComparableTimeMark m1489minusLRDsOJo(ComparableTimeMark $this, long duration) {
            return $this.mo1487plusLRDsOJo(Duration.m1547unaryMinusUwyO8pc(duration));
        }

        public static int compareTo(ComparableTimeMark $this, ComparableTimeMark other) {
            Intrinsics.checkNotNullParameter(other, "other");
            return Duration.m1493compareToLRDsOJo($this.mo1486minusUwyO8pc(other), Duration.Companion.m1597getZEROUwyO8pc());
        }
    }
}
