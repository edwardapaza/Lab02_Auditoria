...
class ShimRegistrar implements PluginRegistry.Registrar, FlutterPlugin, ActivityAware {
    ...
    private void addExistingListenersToActivityPluginBinding() {
        ...
        for (PluginRegistry.WindowFocusChangedListener listener5 : this.WindowFocusChangedListeners) {
            this.activityPluginBinding.addOnWindowFocusChangedListener(listener5);
        }
    }
}
