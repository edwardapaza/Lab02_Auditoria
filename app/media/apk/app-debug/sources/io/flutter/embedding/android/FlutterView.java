...
public class FlutterView extends FrameLayout implements MouseCursorPlugin.MouseCursorViewDelegate, KeyboardManager.ViewDelegate {
    ...
    private int guessBottomKeyboardInset(WindowInsets insets) {
        ...
        if (insets.getSystemWindowInsetBottom() < screenHeight * 0.18d) {
            return 0;
        }
    ...
    public boolean onGenericMotionEvent(MotionEvent event) {
        boolean handled = isAttachedToFlutterEngine() && this.androidTouchProcessor.onGenericMotionEvent(event, getContext());
        if (handled) {
            return true;
        }
