    ...
    public final class IncomingStreamRequestHandler implements BinaryMessenger.BinaryMessageHandler {
        ...
        private void onListen(Object arguments, BinaryMessenger.BinaryReply callback) {
            ...
            try {
                ...
                callback.reply(EventChannel.this.codec.encodeErrorEnvelope(Constants.IPC_BUNDLE_KEY_SEND_ERROR, e2.getMessage(), null));
            }
        }
        ...
        private void onCancel(Object arguments, BinaryMessenger.BinaryReply callback) {
            ...
            if (oldSink == null) {
                callback.reply(EventChannel.this.codec.encodeErrorEnvelope(Constants.IPC_BUNDLE_KEY_SEND_ERROR, "No active stream to cancel", null));
                return;
            }
            try {
                ...
                callback.reply(EventChannel.this.codec.encodeErrorEnvelope(Constants.IPC_BUNDLE_KEY_SEND_ERROR, e.getMessage(), null));
            }
        }
