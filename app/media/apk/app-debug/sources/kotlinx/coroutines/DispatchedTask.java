            ...
            try {
                ...
                try {
                    if (job != null && !job.isActive()) {
                        ...
                        continuation.resumeWith(Result.m168constructorimpl(getSuccessfulResult$kotlinx_coroutines_core(state)));
                    }
                    ...
                    try {
                        ...
                        handleFatalException$kotlinx_coroutines_core(fatalException, Result.m171exceptionOrNullimpl(result));
                    }
                } catch (Throwable th4) {
                    th = th4;
                }
