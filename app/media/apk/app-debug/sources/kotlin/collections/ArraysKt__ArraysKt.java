        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t != t2) {
                ...
                if ((t instanceof Object[]) && (t2 instanceof Object[])) {
                    ...
                    if (!UArraysKt.m738contentEqualskV0jMPg(((UByteArray) t).m253unboximpl(), ((UByteArray) t2).m253unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UShortArray) && (t2 instanceof UShortArray)) {
                    if (!UArraysKt.m736contentEqualsFGO6Aew(((UShortArray) t).m516unboximpl(), ((UShortArray) t2).m516unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UIntArray) && (t2 instanceof UIntArray)) {
                    if (!UArraysKt.m737contentEqualsKJPZfPQ(((UIntArray) t).m332unboximpl(), ((UIntArray) t2).m332unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof ULongArray) && (t2 instanceof ULongArray)) {
                    if (!UArraysKt.m739contentEqualslec5QzE(((ULongArray) t).m411unboximpl(), ((ULongArray) t2).m411unboximpl())) {
                        return false;
                    }
    ...
    private static final <T> void contentDeepToStringInternal$ArraysKt__ArraysKt(T[] tArr, StringBuilder result, List<Object[]> list) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (t == null) {
                ...
                result.append(UArraysKt.m744contentToString2csIQuQ(uByteArray != null ? uByteArray.m253unboximpl() : null));
            } else if (t instanceof UShortArray) {
                UShortArray uShortArray = (UShortArray) t;
                result.append(UArraysKt.m746contentToStringd6D3K8(uShortArray != null ? uShortArray.m516unboximpl() : null));
            } else if (t instanceof UIntArray) {
                UIntArray uIntArray = (UIntArray) t;
                result.append(UArraysKt.m745contentToStringXUkPCBk(uIntArray != null ? uIntArray.m332unboximpl() : null));
            } else if (t instanceof ULongArray) {
                ULongArray uLongArray = (ULongArray) t;
                result.append(UArraysKt.m747contentToStringuLth9ew(uLongArray != null ? uLongArray.m411unboximpl() : null));
            } else {
