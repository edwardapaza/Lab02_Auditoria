...
public final class ViewUtils {
    ...
    public static void calculateMaximumDisplayMetrics(Context context, DisplayUpdater updater) {
        Activity activity = getActivity(context);
        if (activity != null) {
            WindowMetrics metrics = WindowMetricsCalculator.CC.getOrCreate().computeMaximumWindowMetrics(activity);
