...
public interface TimeMark {
    ...
    TimeMark mo1485minusLRDsOJo(long j);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo1487plusLRDsOJo(long j);
    ...
    public static final class DefaultImpls {
        ...
        public static TimeMark m1632plusLRDsOJo(TimeMark $this, long duration) {
            return new AdjustedTimeMark($this, duration, null);
        }

        /* renamed from: minus-LRDsOJo  reason: not valid java name */
        public static TimeMark m1631minusLRDsOJo(TimeMark $this, long duration) {
            return $this.mo1487plusLRDsOJo(Duration.m1547unaryMinusUwyO8pc(duration));
        }

        public static boolean hasPassedNow(TimeMark $this) {
            return !Duration.m1527isNegativeimpl($this.mo1484elapsedNowUwyO8pc());
        }
