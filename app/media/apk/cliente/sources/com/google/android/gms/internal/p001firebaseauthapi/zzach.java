...
public final class zzach {
    ...
    public static u zza(FirebaseAuth firebaseAuth, zzyi zzyiVar, a0 a0Var) {
        zzz.zza(firebaseAuth);
        zzz.zza(zzyiVar);
        Pair<String, String> pair = zza.get(17078);
        return new u((String) pair.first, (String) pair.second, o.y(zzyiVar, firebaseAuth, a0Var));
    }
    ...
    */
    public static f1.l zza(com.google.android.gms.common.api.Status r3) {
        /*
            Method dump skipped, instructions count: 552
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.p001firebaseauthapi.zzach.zza(com.google.android.gms.common.api.Status):f1.l");
    }

    public static l zza(Status status, h hVar, String str, String str2) {
        int u5 = status.u();
        if (u5 == 17012 || u5 == 17007 || u5 == 17025) {
            return new x(zza(u5), zza(zzb(u5), status)).d(hVar).e(str).f(str2);
        }
        return zza(status);
    }

    private static String zza(int i5) {
        Pair<String, String> pair = zza.get(i5);
        return pair != null ? (String) pair.first : "INTERNAL_ERROR";
    }

    private static String zza(String str, Status status) {
        if (TextUtils.isEmpty(status.v())) {
            return str;
        }
        return String.format(str + " [ %s ]", status.v());
    }
    ...
    private static String zzb(int i5) {
        Pair<String, String> pair = zza.get(i5);
