        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 2:
                    ...
                    boolean sendMediaButton = sendMediaButton(_arg0);
                    reply.writeNoException();
                ...
                case 11:
                    ...
                    adjustVolume(_arg011, _arg110, _arg22);
                    reply.writeNoException();
                    return true;
                case 12:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    setVolumeTo(_arg012, _arg111, _arg23);
                    reply.writeNoException();
                    return true;
                case 13:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 14:
                    ...
                    playFromMediaId(_arg013, _arg12);
                    reply.writeNoException();
                    return true;
                case 15:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 26:
                    ...
                    sendCustomAction(_arg015, _arg15);
                    reply.writeNoException();
                    return true;
                case 27:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 34:
                    ...
                    prepareFromMediaId(_arg016, _arg16);
                    reply.writeNoException();
                    return true;
                case 35:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    prepareFromSearch(_arg017, _arg17);
                    reply.writeNoException();
                    return true;
                case 36:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 40:
                    ...
                    setShuffleModeEnabledRemoved(_arg05);
                    reply.writeNoException();
                    return true;
                case 41:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 50:
                    data.enforceInterface(DESCRIPTOR);
                    Bundle _result14 = getSessionInfo();
                    reply.writeNoException();
                    if (_result14 != null) {
                        reply.writeInt(1);
                ...
                case TRANSACTION_rateWithExtras /* 51 */:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg09 = RatingCompat.CREATOR.createFromParcel(data);
                    } else {
                        _arg09 = null;
                    }
                    if (data.readInt() != 0) {
