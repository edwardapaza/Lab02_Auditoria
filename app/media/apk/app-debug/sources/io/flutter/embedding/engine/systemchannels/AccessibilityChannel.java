...
public class AccessibilityChannel {
    ...
    public AccessibilityChannel(DartExecutor dartExecutor, FlutterJNI flutterJNI) {
        BasicMessageChannel.MessageHandler<Object> messageHandler = new BasicMessageChannel.MessageHandler<Object>() { // from class: io.flutter.embedding.engine.systemchannels.AccessibilityChannel.1
            ...
            public void onMessage(Object message, BasicMessageChannel.Reply<Object> reply) {
                ...
                HashMap<String, Object> data = (HashMap) annotatedEvent.get(Constants.ScionAnalytics.MessageType.DATA_MESSAGE);
                ...
                switch (c) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        Integer nodeId3 = (Integer) annotatedEvent.get("nodeId");
                        if (nodeId3 != null) {
                            AccessibilityChannel.this.handler.onFocus(nodeId3.intValue());
                            break;
                        }
                        break;
                    case 4:
    ...
    public AccessibilityChannel(BasicMessageChannel<Object> channel, FlutterJNI flutterJNI) {
