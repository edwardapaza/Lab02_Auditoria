        ...
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt$safeCtor$1
            ...
            public final Throwable invoke(Throwable e) {
                ...
                try {
                    ...
                    m168constructorimpl = Result.m168constructorimpl((Intrinsics.areEqual(e.getMessage(), result.getMessage()) || Intrinsics.areEqual(result.getMessage(), e.toString())) ? result : null);
                } catch (Throwable th) {
                    Result.Companion companion2 = Result.Companion;
                    m168constructorimpl = Result.m168constructorimpl(ResultKt.createFailure(th));
                }
                return Result.m174isFailureimpl(m168constructorimpl) ? null : m168constructorimpl;
            }
        };
    }

    private static final int fieldsCountOrDefault(Class<?> cls, int defaultValue) {
        Integer m168constructorimpl;
