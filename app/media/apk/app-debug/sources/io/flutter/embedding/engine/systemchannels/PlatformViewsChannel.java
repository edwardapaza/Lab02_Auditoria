    ...
    class AnonymousClass1 implements MethodChannel.MethodCallHandler {
        ...
        private void create(MethodCall call, MethodChannel.Result result) {
            ...
            try {
                ...
                result.error(Constants.IPC_BUNDLE_KEY_SEND_ERROR, PlatformViewsChannel.detailedExceptionString(exception), null);
            }
        }
        ...
        private void touch(MethodCall call, MethodChannel.Result result) {
            ...
            try {
                ...
                try {
                    ...
                    exception = e;
                    result2.error(Constants.IPC_BUNDLE_KEY_SEND_ERROR, PlatformViewsChannel.detailedExceptionString(exception), null);
                }
