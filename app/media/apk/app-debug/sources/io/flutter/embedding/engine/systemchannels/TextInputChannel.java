...
public class TextInputChannel {
                ...
                switch (c) {
                    ...
                    case '\b':
                        try {
                            ...
                            String data = arguments3.getString(Constants.ScionAnalytics.MessageType.DATA_MESSAGE);
                            Bundle bundle = null;
    ...
    public void performPrivateCommand(int inputClientId, String action, Bundle data) {
        ...
        if (data != null) {
            ...
            json.put(Constants.ScionAnalytics.MessageType.DATA_MESSAGE, dataMap);
        }
    ...
    public void onConnectionClosed(int inputClientId) {
        ...
        this.channel.invokeMethod("TextInputClient.onConnectionClosed", Arrays.asList(Integer.valueOf(inputClientId), "TextInputClient.onConnectionClosed"));
    }
