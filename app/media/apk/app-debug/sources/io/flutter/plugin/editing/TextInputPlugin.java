...
public class TextInputPlugin implements ListenableEditingState.EditingStateWatcher {
        ...
        if (type.type == TextInputChannel.TextInputType.NUMBER) {
            ...
            if (obscureText) {
                ...
                if (!enableSuggestions) {
                    textType2 = textType2 | 524288 | 144;
                }
            }
    ...
    public void saveEditableSizeAndTransform(double width, double height, final double[] matrix) {
        ...
        minMax[3] = d2;
        minMax[2] = d2;
        MinMax finder = new MinMax() { // from class: io.flutter.plugin.editing.TextInputPlugin.3
        ...
        this.lastClientRect = new Rect((int) (density.floatValue() * minMax[0]), (int) (minMax[2] * density.floatValue()), (int) Math.ceil(minMax[1] * density.floatValue()), (int) Math.ceil(minMax[3] * density.floatValue()));
    }
