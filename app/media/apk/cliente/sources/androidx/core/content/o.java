...
public final class o {
    public static int a(Context context, String str, int i5, int i6, String str2) {
        ...
        String c5 = androidx.core.app.j.c(str);
        if (c5 == null) {
            return 0;
        }
        if (str2 == null) {
        ...
        return (Process.myUid() == i6 && k.c.a(context.getPackageName(), str2) ? androidx.core.app.j.a(context, i6, c5, str2) : androidx.core.app.j.b(context, c5, str2)) == 0 ? 0 : -2;
    }
