...
final class AdjustedTimeMark implements TimeMark {
    ...
    public final long m1488getAdjustmentUwyO8pc() {
    ...
    public TimeMark mo1485minusLRDsOJo(long duration) {
        return TimeMark.DefaultImpls.m1631minusLRDsOJo(this, duration);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: elapsedNow-UwyO8pc */
    public long mo1484elapsedNowUwyO8pc() {
        return Duration.m1529minusLRDsOJo(this.mark.mo1484elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo1487plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m1530plusLRDsOJo(this.adjustment, duration), null);
    }
}
