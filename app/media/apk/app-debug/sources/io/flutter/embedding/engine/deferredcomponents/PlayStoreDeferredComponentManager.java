...
public class PlayStoreDeferredComponentManager implements DeferredComponentManager {
        ...
        if (resolvedComponentName == null) {
            ...
            this.splitInstallManager.startInstall(request).addOnSuccessListener(new OnSuccessListener() { // from class: io.flutter.embedding.engine.deferredcomponents.PlayStoreDeferredComponentManager$$ExternalSyntheticLambda0
                public final void onSuccess(Object obj) {
                    PlayStoreDeferredComponentManager.this.m131x3d4be899(resolvedComponentName, loadingUnitId, (Integer) obj);
                }
                ...
                public final void onFailure(Exception exc) {
                    PlayStoreDeferredComponentManager.this.m132x6bfd52b8(loadingUnitId, componentName, exc);
                }
            });
        }
    }
    ...
    public /* synthetic */ void m131x3d4be899(String resolvedComponentName, int loadingUnitId, Integer sessionId) {
    ...
    public /* synthetic */ void m132x6bfd52b8(int loadingUnitId, String componentName, Exception exception) {
        switch (((SplitInstallException) exception).getErrorCode()) {
            case -6:
                this.flutterJNI.deferredComponentInstallFailure(loadingUnitId, "Install of deferred component module \"" + componentName + "\" failed with a network error", true);
                return;
            case -2:
                this.flutterJNI.deferredComponentInstallFailure(loadingUnitId, "Install of deferred component module \"" + componentName + "\" failed as it is unavailable", false);
                return;
            default:
