...
public class PlatformPlugin {
    ...
    public interface PlatformPluginDelegate {
        ...
        public final /* synthetic */ class CC {
            public static void $default$setFrameworkHandlesBack(PlatformPluginDelegate _this, boolean frameworkHandlesBack) {
            }
        }
    }
    ...
    public class AnonymousClass2 implements View.OnSystemUiVisibilityChangeListener {
        ...
        public void onSystemUiVisibilityChange(final int visibility) {
            this.val$decorView.post(new Runnable() { // from class: io.flutter.plugin.platform.PlatformPlugin$2$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    PlatformPlugin.AnonymousClass2.this.m136x970b83d5(visibility);
                }
            });
        }
        ...
        public /* synthetic */ void m136x970b83d5(int visibility) {
            if ((visibility & 4) == 0) {
        ...
        if (clipboard.hasPrimaryClip()) {
            try {
                ...
                if (itemText == null) {
                    ...
                    AssetFileDescriptor assetFileDescriptor = this.activity.getContentResolver().openTypedAssetFileDescriptor(itemUri, "text/*", null);
                    itemText = item.coerceToText(this.activity);
                ...
                Log.w(TAG, "Failed to close AssetFileDescriptor while trying to read text from URI.", e2);
                return null;
