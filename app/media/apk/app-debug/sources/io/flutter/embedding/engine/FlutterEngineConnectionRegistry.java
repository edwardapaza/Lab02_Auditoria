...
public class FlutterEngineConnectionRegistry implements PluginRegistry, ActivityControlSurface, ServiceControlSurface, BroadcastReceiverControlSurface, ContentProviderControlSurface {
    ...
    public void add(FlutterPlugin plugin) {
        TraceSection e = TraceSection.scoped("FlutterEngineConnectionRegistry#add " + plugin.getClass().getSimpleName());
        try {
    ...
    public void remove(Class<? extends FlutterPlugin> pluginClass) {
        ...
        TraceSection e = TraceSection.scoped("FlutterEngineConnectionRegistry#remove " + pluginClass.getSimpleName());
        try {
            if (plugin instanceof ActivityAware) {
                if (isAttachedToActivity()) {
                    ActivityAware activityAware = (ActivityAware) plugin;
    ...
    public void attachToActivity(ExclusiveAppComponent<Activity> exclusiveActivity, Lifecycle lifecycle) {
        TraceSection e = TraceSection.scoped("FlutterEngineConnectionRegistry#attachToActivity");
        try {
            ExclusiveAppComponent<Activity> exclusiveAppComponent = this.exclusiveActivity;
            if (exclusiveAppComponent != null) {
    ...
    public void detachFromActivityForConfigChanges() {
        if (isAttachedToActivity()) {
            TraceSection e = TraceSection.scoped("FlutterEngineConnectionRegistry#detachFromActivityForConfigChanges");
            try {
    ...
    public void detachFromActivity() {
        if (isAttachedToActivity()) {
            TraceSection e = TraceSection.scoped("FlutterEngineConnectionRegistry#detachFromActivity");
            try {
                for (ActivityAware activityAware : this.activityAwarePlugins.values()) {
                    activityAware.onDetachedFromActivity();
                }
    ...
    public boolean onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResult) {
        if (isAttachedToActivity()) {
            TraceSection e = TraceSection.scoped("FlutterEngineConnectionRegistry#onRequestPermissionsResult");
            try {
                boolean onRequestPermissionsResult = this.activityPluginBinding.onRequestPermissionsResult(requestCode, permissions, grantResult);
                if (e != null) {
                    e.close();
                }
    ...
    public boolean onActivityResult(int requestCode, int resultCode, Intent data) {
        if (isAttachedToActivity()) {
            TraceSection e = TraceSection.scoped("FlutterEngineConnectionRegistry#onActivityResult");
            try {
                boolean onActivityResult = this.activityPluginBinding.onActivityResult(requestCode, resultCode, data);
                if (e != null) {
                    e.close();
                }
    ...
    public void onNewIntent(Intent intent) {
        if (isAttachedToActivity()) {
            TraceSection e = TraceSection.scoped("FlutterEngineConnectionRegistry#onNewIntent");
            try {
    ...
    public void onUserLeaveHint() {
        if (isAttachedToActivity()) {
            TraceSection e = TraceSection.scoped("FlutterEngineConnectionRegistry#onUserLeaveHint");
            try {
    ...
    public void onSaveInstanceState(Bundle bundle) {
        if (isAttachedToActivity()) {
            TraceSection e = TraceSection.scoped("FlutterEngineConnectionRegistry#onSaveInstanceState");
            try {
    ...
    public void onRestoreInstanceState(Bundle bundle) {
        if (isAttachedToActivity()) {
            TraceSection e = TraceSection.scoped("FlutterEngineConnectionRegistry#onRestoreInstanceState");
            try {
    ...
    public void attachToService(Service service, Lifecycle lifecycle, boolean isForeground) {
        TraceSection e = TraceSection.scoped("FlutterEngineConnectionRegistry#attachToService");
        try {
            detachFromAppComponent();
    ...
    public void detachFromService() {
        if (isAttachedToService()) {
            TraceSection e = TraceSection.scoped("FlutterEngineConnectionRegistry#detachFromService");
            try {
                for (ServiceAware serviceAware : this.serviceAwarePlugins.values()) {
                    serviceAware.onDetachedFromService();
                }
    ...
    public void onMoveToForeground() {
        if (isAttachedToService()) {
            TraceSection e = TraceSection.scoped("FlutterEngineConnectionRegistry#onMoveToForeground");
            try {
    ...
    public void onMoveToBackground() {
        if (isAttachedToService()) {
            TraceSection e = TraceSection.scoped("FlutterEngineConnectionRegistry#onMoveToBackground");
            try {
    ...
    public void attachToBroadcastReceiver(BroadcastReceiver broadcastReceiver, Lifecycle lifecycle) {
        TraceSection e = TraceSection.scoped("FlutterEngineConnectionRegistry#attachToBroadcastReceiver");
        try {
            detachFromAppComponent();
    ...
    public void detachFromBroadcastReceiver() {
        if (isAttachedToBroadcastReceiver()) {
            TraceSection e = TraceSection.scoped("FlutterEngineConnectionRegistry#detachFromBroadcastReceiver");
            try {
                for (BroadcastReceiverAware broadcastReceiverAware : this.broadcastReceiverAwarePlugins.values()) {
                    broadcastReceiverAware.onDetachedFromBroadcastReceiver();
                }
    ...
    public void attachToContentProvider(ContentProvider contentProvider, Lifecycle lifecycle) {
        TraceSection e = TraceSection.scoped("FlutterEngineConnectionRegistry#attachToContentProvider");
        try {
            detachFromAppComponent();
    ...
    public void detachFromContentProvider() {
        if (isAttachedToContentProvider()) {
            TraceSection e = TraceSection.scoped("FlutterEngineConnectionRegistry#detachFromContentProvider");
            try {
                for (ContentProviderAware contentProviderAware : this.contentProviderAwarePlugins.values()) {
                    contentProviderAware.onDetachedFromContentProvider();
                }
    ...
    public static class FlutterEngineActivityPluginBinding implements ActivityPluginBinding {
        ...
        @Override // io.flutter.embedding.engine.plugins.activity.ActivityPluginBinding
        public void addOnWindowFocusChangedListener(PluginRegistry.WindowFocusChangedListener listener) {
            this.onWindowFocusChangedListeners.add(listener);
        }

        @Override // io.flutter.embedding.engine.plugins.activity.ActivityPluginBinding
        public void removeOnWindowFocusChangedListener(PluginRegistry.WindowFocusChangedListener listener) {
