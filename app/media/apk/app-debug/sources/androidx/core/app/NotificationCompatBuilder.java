...
public class NotificationCompatBuilder implements NotificationBuilderWithBuilderAccessor {
    ...
    public NotificationCompatBuilder(NotificationCompat.Builder b) {
        ...
        if (Build.VERSION.SDK_INT >= 20 && (b.mStyle instanceof NotificationCompat.CallStyle)) {
    ...
    protected Notification buildInternal() {
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            ...
            if (this.mGroupAlertBehavior != 0) {
                if (Api20Impl.getGroup(notification3) != null && (notification3.flags & 512) != 0 && this.mGroupAlertBehavior == 2) {
                    removeSoundAndVibration(notification3);
                }
                if (Api20Impl.getGroup(notification3) != null && (notification3.flags & 512) == 0 && this.mGroupAlertBehavior == 1) {
                    removeSoundAndVibration(notification3);
                }
            }
