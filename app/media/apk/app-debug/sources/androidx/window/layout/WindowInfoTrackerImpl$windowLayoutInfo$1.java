...
final class WindowInfoTrackerImpl$windowLayoutInfo$1 extends SuspendLambda implements Function2<FlowCollector<? super WindowLayoutInfo>, Continuation<? super Unit>, Object> {
    ...
    /* JADX WARN: Removed duplicated region for block: B:23:0x008b A[Catch: all -> 0x00b6, TRY_LEAVE, TryCatch #0 {all -> 0x00b6, blocks: (B:21:0x0083, B:23:0x008b), top: B:36:0x0083 }] */
    ...
    */
    ...
    public static final void m51invokeSuspend$lambda0(Channel $channel, WindowLayoutInfo info) {
        Intrinsics.checkNotNullExpressionValue(info, "info");
        $channel.mo1671trySendJP2dKIU(info);
    }
}
