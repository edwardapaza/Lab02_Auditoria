...
public final class CctTransportBackend implements TransportBackend {
    ...
    public HttpResponse doSend(HttpRequest request) throws IOException {
        ...
        connection.setRequestProperty("User-Agent", String.format("datatransport/%s android/", "3.1.8"));
        ...
        try {
            ...
            try {
                ...
                Logging.d(LOG_TAG, "Content-Type: %s", connection.getHeaderField(CONTENT_TYPE_HEADER_KEY));
                Logging.d(LOG_TAG, "Content-Encoding: %s", connection.getHeaderField(CONTENT_ENCODING_HEADER_KEY));
